...
@OUTPUT: { "marker": "FUNCTIONAL_BUG / DESIGN_ISSUE / KNOWN_ISSUE / SCOPE_ESCALATE", "severity": "LOW / MEDIUM / HIGH", "routing": "impl / design / scope_escalate", "github_issue": "생성/연결된 GitHub 이슈 번호" }
```
