...
@OUTPUT: { "marker": "FUNCTIONAL_BUG / DESIGN_ISSUE / KNOWN_ISSUE / SCOPE_ESCALATE", "severity": "LOW / MEDIUM / HIGH", "routing": "impl / design / scope_escalate", "github_issue?": "생성된 GitHub 이슈 번호 (DESIGN_ISSUE는 이슈 생성 안 함 — designer가 담당)" }
```
