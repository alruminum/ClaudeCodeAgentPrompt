...
- 아이콘 + 제목 + 설명 3줄 반복 패턴
- 🚫 **다크 네이비/미드나잇 배경 + 골드/오렌지/앰버 단일 엑센트** = "Claude/AI 클리셰 톤". 슬립/명상/오디오 류 앱에서 자동 발현되는 판박이 톤이라 즉시 재선정. 다른 색조(예: 새벽 보라+민트, 따뜻한 베이지+코랄, 흙갈색+세이지 그린)로 차별화. (jajang 2026-04-26 reject 사례)
