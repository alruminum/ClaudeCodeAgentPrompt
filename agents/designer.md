...
@PARAMS: { "screen": "대상 화면/컴포넌트명", "ui_spec": "docs/ui-spec.md 경로 (선택)", "impl_path": "관련 impl 파일 경로 (선택)" }

@MODE:DESIGNER:FIGMA
@PARAMS: { "screen": "대상 화면/컴포넌트명", "figma_url": "Figma 파일 URL" }

@MODE:DESIGNER:UX_REDESIGN
@PARAMS: { "screen": "전체 화면명", "current_issues": "현재 UX 문제점 (선택)", "ui_spec": "docs/ui-spec.md 경로 (선택)" }
```
