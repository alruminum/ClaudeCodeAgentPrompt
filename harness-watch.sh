...
#   PLAN_VALIDATION_ESCALATE, DESIGN_DONE, DESIGN_ESCALATE,
#   PLAN_DONE, UI_DESIGN_REQUIRED, SPEC_GAP_ESCALATE
...
TERMINAL_RE="HARNESS_DONE|IMPLEMENTATION_ESCALATE|PLAN_VALIDATION_PASS|PLAN_VALIDATION_ESCALATE|DESIGN_DONE|DESIGN_ESCALATE|PLAN_DONE|UI_DESIGN_REQUIRED|SPEC_GAP_ESCALATE"
