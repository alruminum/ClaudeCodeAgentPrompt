...
DRIFT_MAP = {
    ...
    'orchestration-rules.md': [
        ...
        'harness/helpers.py', 'harness/plan_loop.py',
        'harness/core.py', 'harness/config.py',
    ],
    'agents/qa.md': ['commands/qa.md'],
    'agents/architect.md': ['harness/impl_router.py', 'harness/plan_loop.py'],
    'agents/validator.md': [
        'harness/impl_loop.py', 'harness/impl_router.py', 'harness/plan_loop.py',
    ],
    'agents/engineer.md': ['harness/impl_loop.py', 'harness/helpers.py'],
    'agents/test-engineer.md': ['harness/impl_loop.py'],
    ...
    'agents/ux-architect.md': ['harness/plan_loop.py', 'harness/core.py', 'commands/ux.md'],
